...
--
-- Host: localhost
-- Generation Time: Feb 22, 2019 at 06:26 AM
...
(8, 'Which program obtains a remote reference to one or more remote objects on a server and then invokes methods on them in an RMI application?', 'Server', 'Client', 'Both A & B', 'none', 2),
...
('asaskapilchhipa4@gmail.com', 0, 0, 0, 0, 0, 0, 0, 2, 0, 2),
