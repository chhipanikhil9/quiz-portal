...
{	$index=$array['id'];
	...
	<h5  <?php if($array2[$index]=='1'){ ?>style="background-color: green;padding: 10px;border:1px solid gray;"; <?php } ?> 
<?php if($array2[$index]=='2'){ ?>style="background-color: red;padding: 10px;border:1px solid red;""; <?php } ?>
<?php if($array2[$index]=='0'){ ?>style="background-color: yellow;padding: 10px;border:5px solid yellow;" <?php } ?> >Q.<?php echo $array['id']." ".$array['question']; ?> </h5>
	<?php $name=$array['id'];?>
	<label class="container1">
